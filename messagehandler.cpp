...
void MessageHandler::setLogFile(QString file) { s_log = file; }

void MessageHandler::FormatMessage(QtMsgType type,
  ...
  log += QString(context.file) + QString(", Line ") +
         QString::number(context.line) + QString(": %1\n").arg(msg);
